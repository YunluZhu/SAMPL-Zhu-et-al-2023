...
def get_kinetics(df):
    """get kinetics measurements: righting gain, steering tgain, set point

    Args:
        df (Dataframe): dataframe with bout features

    Returns:
        series: dataframe with analyzed kinetics
    """
