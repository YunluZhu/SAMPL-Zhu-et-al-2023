...
print("- Figure 6: ZF strains - Fin-body coordination")

root, FRAME_RATE = get_data_dir(pick_data)

folder_name = f'{pick_data} fin-body coordination'
folder_dir = get_figure_dir('Fig_6')
...
for (cond_abla,cond_dpf,cond_ztime), for_fit in all_feature_cond.groupby(['condition','dpf','ztime']):
    ...
    binned_df = distribution_binned_average_nostd(for_fit,by_col='rot_pre_bout',bin_col='atk_ang',bin=AVERAGE_BIN)
