...
folder_name = f'{pick_data} righting steering'
...
# %%
print("Figure 5: Linear regression for kinetics")
# steering
print("- Steering Gain")
xcol = 'traj_peak'
ycol = 'pitch_peak'
...
plt.savefig(fig_dir6+"/Righting fit.pdf",format='PDF')
plt.close()
...
plt.savefig(fig_dir6+"/Set point.pdf",format='PDF')
plt.close()
