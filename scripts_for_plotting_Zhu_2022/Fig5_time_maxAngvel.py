...
# # %%
# # calculate time of max adj ang speed of every bout, then average
# initial_bound = -0.2 #ms
# df_tocalc = exp_data_all.loc[exp_data_all['time_ms']<100]
...
mean_angAccel = exp_data_all.groupby(['time_ms','expNum','cond1','cond2'])['angvel (deg/s)'].median().reset_index()
mean_angAccel = mean_angAccel.loc[mean_angAccel['time_ms']<100]
idx_mean_max = mean_angAccel.groupby(['expNum','cond1','cond2'])['angvel (deg/s)'].apply(
