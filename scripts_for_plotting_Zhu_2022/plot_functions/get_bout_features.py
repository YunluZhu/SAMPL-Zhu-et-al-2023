            ...
            if subdir_list:
                ...
                for expNum, exp in enumerate(subdir_list):
                    ...
                    if not max_angvel_time.empty:
                        max_angvel_time.query("cond1 == @cond1 and cond2 == @cond2")
                        ...
                        this_exp_features = extract_bout_features_v4(trunc_exp_data,peak_idx,FRAME_RATE,idx_max_angvel=idx_max_angvel)
                    else:
