...
from plot_functions.plt_tools import (jackknife_mean, set_font_type, distribution_binned_average_nostd)
from plot_functions.get_bout_kinetics import get_bout_kinetics
from scipy import stats

def Fig6_rightingCorr_pitchInitial_pitchMaxAngvel(root):
    set_font_type()
    # defaultPlotting()v
    # %%
    which_ztime = 'day'
    FRAME_RATE = 166
    folder_name = f'Righting correlation'
...
if __name__ == "__main__":
    ...
    Fig6_rightingCorr_pitchInitial_pitchMaxAngvel(root)